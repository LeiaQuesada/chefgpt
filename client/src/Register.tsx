    ...
    <div className="register-page">
      <div className="register-card">
        ...
        <form className="register-form" onSubmit={handleSubmit} noValidate>
          ...
          <div>
            <label htmlFor="register-confirm" className="register-label">Confirm Password</label>
            <input
              id="register-confirm"
              name="confirm"
              type="password"
          ...
          <div className="register-file-row">
            <label htmlFor="register-file" className="register-label" style={{ marginBottom: 0 }}>Profile picture (optional)</label>
            <input
              id="register-file"
              name="profilePic"
              type="file"
            ...
            <button
              ...
              onClick={() => document.getElementById('register-file')?.click()}
            ...
            {fileName && <span className="register-file-name">{fileName}</span>}
          </div>
          ...
          <div className="register-actions">
            <button
              ...
              onFocus={() => setFocus(f => ({ ...f, submit: true }))}
              onBlur={() => setFocus(f => ({ ...f, submit: false }))}
            >
              Create Account
            </button>
          </div>
